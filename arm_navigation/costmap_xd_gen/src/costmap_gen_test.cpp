...
/*	if (argc != 8||
	...
	costmap1.costmap.size[0]=100;
	costmap1.costmap.size[1]=100;
	costmap1.costmap.size[2]=100;
	...
	cloud4view.header.frame_id="arm_link";
	...
	for(int i=0;i<costmap1.costmap.size[2];i++)
	{
		for(int j=0;j<costmap1.costmap.size[1];j++)
		{
			...
			{
				cloud4view.points[ii].x=k/100.0;
				cloud4view.points[ii].y=j/100.0;
				cloud4view.points[ii].z=i/100.0;
